...
I do hope that, one day, Kafka Streams will implement the Apache Beam model. This would allow Kafka Streams to offer a great processing model as well as to offer a simple deployment model. The best of both worlds.
